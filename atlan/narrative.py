...
class NarrativeNode:
    ...
    def get_state(self) -> Dict[str, Any]:
        """Returns narrative state."""
        return {
            "personality_flags": self.personality_flags,
            "summary_log": self.summary_log,
            "last_narrative": self.last_narrative
        }

    def load_state(self, state: Dict[str, Any]):
        """Restores narrative state."""
        self.personality_flags = state.get("personality_flags", [])
        self.summary_log = state.get("summary_log", [])
        self.last_narrative = state.get("last_narrative")
